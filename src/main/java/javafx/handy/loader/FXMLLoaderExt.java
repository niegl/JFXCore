...
public class FXMLLoaderExt {
    ...
    private abstract class Element {
        public final FXMLLoaderExt.Element parent;

        public Object value = null;
        private BeanAdapter valueAdapter = null;

        public final LinkedList<FXMLLoaderExt.Attribute> eventHandlerAttributes = new LinkedList<>();
        public final LinkedList<FXMLLoaderExt.Attribute> instancePropertyAttributes = new LinkedList<>();
        public final LinkedList<FXMLLoaderExt.Attribute> staticPropertyAttributes = new LinkedList<>();
        public final LinkedList<FXMLLoaderExt.PropertyElement> staticPropertyElements = new LinkedList<>();
        ...
        public void processInstancePropertyAttributes() throws IOException {
            if (instancePropertyAttributes.size() > 0) {
                for (FXMLLoaderExt.Attribute attribute : instancePropertyAttributes) {
        ...
        public void processAttribute(String prefix, String localName, String value)
            ...
            if (prefix == null) {
                ...
                if (localName.startsWith(EVENT_HANDLER_PREFIX)) {
                    ...
                    eventHandlerAttributes.add(new FXMLLoaderExt.Attribute(localName, null, value));
                } else {
                    ...
                    if (i == -1) {
                        ...
                        instancePropertyAttributes.add(new FXMLLoaderExt.Attribute(localName, null, value));
                    } else {
                        ...
                        if (sourceType != null) {
                            ...
                            staticPropertyAttributes.add(new FXMLLoaderExt.Attribute(name, sourceType, value));
                        } else if (staticLoad) {
                            if (loadListener != null) {
        ...
        @SuppressWarnings("unchecked")
        public void processPropertyAttribute(FXMLLoaderExt.Attribute attribute) throws IOException {
            ...
            if (aValue.startsWith(ESCAPE_PREFIX)) {
                ...
                if (aValue.startsWith(RELATIVE_PATH_PREFIX)) {
                    ...
                    if (aValue.charAt(0) == '/') {
                        ...
                        try {
                            return new URL(FXMLLoaderExt.this.location, aValue).toString();
                        } catch (MalformedURLException e) {
                            System.err.println(FXMLLoaderExt.this.location + "/" + aValue);
                        }
                    }
                }
        ...
        private FXMLLoaderExt.MethodHandler getControllerMethodHandle(String handlerName, FXMLLoaderExt.SupportedType... types) throws LoadException {
            if (handlerName.startsWith(CONTROLLER_METHOD_PREFIX)) {
                ...
                if (!handlerName.startsWith(CONTROLLER_METHOD_PREFIX)) {
                    ...
                    for (FXMLLoaderExt.SupportedType t : types) {
                        Method method = controllerAccessor
                                .getControllerMethods()
                                .get(t)
                                .get(handlerName);
                        if (method != null) {
                            return new FXMLLoaderExt.MethodHandler(controller, method, t);
                        }
                    }
                    Method method = controllerAccessor
                            .getControllerMethods()
                            .get(FXMLLoaderExt.SupportedType.PARAMETERLESS)
                            .get(handlerName);
                    if (method != null) {
                        return new FXMLLoaderExt.MethodHandler(controller, method, FXMLLoaderExt.SupportedType.PARAMETERLESS);
                    }
        ...
        public void processEventHandlerAttributes() throws LoadException {
            if (eventHandlerAttributes.size() > 0 && !staticLoad) {
                for (FXMLLoaderExt.Attribute attribute : eventHandlerAttributes) {
                    ...
                    if (value instanceof ObservableList && attribute.name.equals(COLLECTION_HANDLER_NAME)) {
                        ...
                        FXMLLoaderExt.MethodHandler handler = getControllerMethodHandle(handlerName, FXMLLoaderExt.SupportedType.EVENT);
                        if (handler != null) {
                            eventHandler = new FXMLLoaderExt.ControllerMethodEventHandler<>(handler);
                        }
                        ...
                        if (eventHandler == null) {
                            ...
                            eventHandler = new FXMLLoaderExt.ScriptEventHandler(handlerName, scriptEngine, location.getPath()
        ...
        private void processObservableListHandler(String handlerValue) throws LoadException {
            ...
            if (handlerValue.startsWith(CONTROLLER_METHOD_PREFIX)) {
                FXMLLoaderExt.MethodHandler handler = getControllerMethodHandle(handlerValue, FXMLLoaderExt.SupportedType.LIST_CHANGE_LISTENER);
                if (handler != null) {
                    list.addListener(new FXMLLoaderExt.ObservableListChangeAdapter(handler));
                } else {
        ...
        private void processObservableMapHandler(String handlerValue) throws LoadException {
            ...
            if (handlerValue.startsWith(CONTROLLER_METHOD_PREFIX)) {
                FXMLLoaderExt.MethodHandler handler = getControllerMethodHandle(handlerValue, FXMLLoaderExt.SupportedType.MAP_CHANGE_LISTENER);
                if (handler != null) {
                    map.addListener(new FXMLLoaderExt.ObservableMapChangeAdapter(handler));
                } else {
                    throw constructLoadException("Controller method \"" + handlerValue + "\" not found.");
                }
            } else if (handlerValue.startsWith(EXPRESSION_PREFIX)) {
        ...
        private void processObservableSetHandler(String handlerValue) throws LoadException {
            ...
            if (handlerValue.startsWith(CONTROLLER_METHOD_PREFIX)) {
                FXMLLoaderExt.MethodHandler handler = getControllerMethodHandle(handlerValue, FXMLLoaderExt.SupportedType.SET_CHANGE_LISTENER);
                if (handler != null) {
                    set.addListener(new FXMLLoaderExt.ObservableSetChangeAdapter(handler));
                } else {
                    throw constructLoadException("Controller method \"" + handlerValue + "\" not found.");
                }
            } else if (handlerValue.startsWith(EXPRESSION_PREFIX)) {
        ...
        private void processPropertyHandler(String attributeName, String handlerValue) throws LoadException {
            ...
            if (i != j) {
                ...
                if (handlerValue.startsWith(CONTROLLER_METHOD_PREFIX)) {
                    final FXMLLoaderExt.MethodHandler handler = getControllerMethodHandle(handlerValue, FXMLLoaderExt.SupportedType.PROPERTY_CHANGE_LISTENER, FXMLLoaderExt.SupportedType.EVENT);
                    if (handler != null) {
                        if (handler.type == FXMLLoaderExt.SupportedType.EVENT) {
                            ...
                            propertyModel.addListener(new FXMLLoaderExt.PropertyChangeAdapter(handler));
                        }
                    } else {
                        throw constructLoadException("Controller method \"" + handlerValue + "\" not found.");
                    }
    ...
    private abstract class ValueElement extends FXMLLoaderExt.Element {
        ...
        public void processEndElement() throws IOException {
            ...
            if (staticPropertyAttributes.size() > 0) {
                for (FXMLLoaderExt.Attribute attribute : staticPropertyAttributes) {
                    processPropertyAttribute(attribute);
                }
            }
            ...
            if (staticPropertyElements.size() > 0) {
                for (FXMLLoaderExt.PropertyElement element : staticPropertyElements) {
        ...
        private Object getListValue(FXMLLoaderExt.Element parent, String listPropertyName, Object value) {
...
//                    }
    ...
    private class InstanceDeclarationElement extends FXMLLoaderExt.ValueElement {
        public Class<?> type;
    ...
    private class UnknownTypeElement extends FXMLLoaderExt.ValueElement {
        ...
        public Object constructValue() throws LoadException {
            return new FXMLLoaderExt.UnknownTypeElement.UnknownValueMap();
        }
    }

    // Element representing an include
    private class IncludeElement extends FXMLLoaderExt.ValueElement {
        public String source = null;
        public ResourceBundle resources = FXMLLoaderExt.this.resources;
        public Charset charset = FXMLLoaderExt.this.charset;
            ...
            if (prefix == null) {
                if (localName.equals(INCLUDE_SOURCE_ATTRIBUTE)) {
                    ...
                    resources = ResourceBundle.getBundle(value, Locale.getDefault(),
                            FXMLLoaderExt.this.resources.getClass().getClassLoader());
        ...
        public Object constructValue() throws IOException {
            ...
            if (source.charAt(0) == '/') {
                ...
                if (FXMLLoaderExt.this.location == null) {
                    throw constructLoadException("Base location is undefined.");
                }

                location = new URL(FXMLLoaderExt.this.location, source);
            }

            FXMLLoaderExt fxmlLoader = new FXMLLoaderExt(location, resources,
                    builderFactory, controllerFactory, charset,
                    loaders);
            fxmlLoader.parentLoader = FXMLLoaderExt.this;

            if (isCyclic(FXMLLoaderExt.this, fxmlLoader)) {
                throw new IOException(
                        String.format(
                                "Including \"%s\" in \"%s\" created cyclic reference.",
                                fxmlLoader.location.toExternalForm(),
                                FXMLLoaderExt.this.location.toExternalForm()));
            }
    ...
    private class ReferenceElement extends FXMLLoaderExt.ValueElement {
        public String source = null;
    ...
    private class CopyElement extends FXMLLoaderExt.ValueElement {
        public String source = null;
    ...
    private class RootElement extends FXMLLoaderExt.ValueElement {
    ...
    private class PropertyElement extends FXMLLoaderExt.Element {
    ...
    private class UnknownStaticPropertyElement extends FXMLLoaderExt.Element {
    ...
    private class ScriptElement extends FXMLLoaderExt.Element {
        public String source = null;
        public Charset charset = FXMLLoaderExt.this.charset;
    ...
    private class DefineElement extends FXMLLoaderExt.Element {
        @Override
        public boolean isCollection() {
            return true;
        }
    ...
    private static class ControllerMethodEventHandler<T extends Event> implements EventHandler<T> {
        private final FXMLLoaderExt.MethodHandler handler;

        public ControllerMethodEventHandler(FXMLLoaderExt.MethodHandler handler) {
    ...
    private static class ObservableListChangeAdapter implements ListChangeListener {
        ...
        public ObservableListChangeAdapter(FXMLLoaderExt.MethodHandler handler) {
            this.handler = handler;
        }
    ...
    private static class ObservableMapChangeAdapter implements MapChangeListener {
        public final FXMLLoaderExt.MethodHandler handler;

        public ObservableMapChangeAdapter(FXMLLoaderExt.MethodHandler handler) {
            this.handler = handler;
        }
    ...
    private static class ObservableSetChangeAdapter implements SetChangeListener {
        ...
        public ObservableSetChangeAdapter(FXMLLoaderExt.MethodHandler handler) {
            this.handler = handler;
        }
    ...
    private static class PropertyChangeAdapter implements ChangeListener<Object> {
        ...
        public PropertyChangeAdapter(FXMLLoaderExt.MethodHandler handler) {
            this.handler = handler;
        }
    ...
    private static class MethodHandler {
        ...
        private final FXMLLoaderExt.SupportedType type;

        private MethodHandler(Object controller, Method method, FXMLLoaderExt.SupportedType type) {
            this.method = method;
        ...
        public void invoke(Object... params) {
            try {
                if (type != FXMLLoaderExt.SupportedType.PARAMETERLESS) {
    ...
    private final LinkedList<FXMLLoaderExt> loaders;

    private ClassLoader classLoader = null;
    private boolean staticLoad = false;
    private LoadListener loadListener = null;

    private FXMLLoaderExt parentLoader;

    private XMLStreamReader xmlStreamReader = null;
    private FXMLLoaderExt.Element current = null;
    ...
    static {
        ...
        FXMLLoaderHelperExt.setFXMLLoaderAccessor(new FXMLLoaderHelperExt.FXMLLoaderAccessor() {
            @Override
            public void setStaticLoad(FXMLLoaderExt fxmlLoader, boolean staticLoad) {
                fxmlLoader.setStaticLoad(staticLoad);
            }
        });
    }
     ...
     * @since JavaFX 2.1
     */
    public FXMLLoaderExt(URL location) {
        this(location, null);
    }
     ...
     * @since JavaFX 2.1
     */
    public FXMLLoaderExt(URL location, ResourceBundle resources) {
     ...
     * @since JavaFX 2.1
     */
    public FXMLLoaderExt(URL location, ResourceBundle resources, BuilderFactory builderFactory) {
     ...
     */
    public FXMLLoaderExt(Charset charset) {
    ...
    public FXMLLoaderExt(URL location, ResourceBundle resources, BuilderFactory builderFactory,
                      Callback<Class<?>, Object> controllerFactory, Charset charset,
                      LinkedList<FXMLLoaderExt> loaders) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof FXMLLoaderExt) {
            FXMLLoaderExt loader = (FXMLLoaderExt)obj;
    ...
    private String constructFXMLTrace() {
        ...
        for (FXMLLoaderExt loader : loaders) {
        ...
        if (prefix == null) {
            ...
            if (Character.isLowerCase(localName.charAt(i + 1))) {
                ...
                if (i == -1) {
                    ...
                    current = new FXMLLoaderExt.PropertyElement(name, null);
                } else {
                    ...
                    if (sourceType != null) {
                        ...
                        current = new FXMLLoaderExt.PropertyElement(name, sourceType);
                    } else if (staticLoad) {
                        ...
                        current = new FXMLLoaderExt.UnknownStaticPropertyElement();
                    } else {
                ...
                if (type != null) {
                    ...
                    current = new FXMLLoaderExt.InstanceDeclarationElement(type);
                } else if (staticLoad) {
                    ...
                    current = new FXMLLoaderExt.UnknownTypeElement();
                } else {
    ...
    private static FXMLLoaderExt.SupportedType toSupportedType(Method m) {
        for (FXMLLoaderExt.SupportedType t : FXMLLoaderExt.SupportedType.values()) {
    ...
    private static boolean needsClassLoaderPermissionCheck(Class caller) {
        ...
        return !FXMLLoaderExt.class.getModule().equals(caller.getModule());
    }
    ...
    public static void setDefaultClassLoader(ClassLoader defaultClassLoader) {
        ...
        FXMLLoaderExt.defaultClassLoader = defaultClassLoader;
    }
    ...
    private static <T> T loadImpl(URL location, ResourceBundle resources,
        ...
        FXMLLoaderExt fxmlLoader =
                new FXMLLoaderExt(location, resources, builderFactory,
    ...
    private final FXMLLoaderExt.ControllerAccessor controllerAccessor =
            new FXMLLoaderExt.ControllerAccessor();
    ...
    private static final class ControllerAccessor {
        ...
        private Map<FXMLLoaderExt.SupportedType, Map<String, Method>> controllerMethods;
        ...
        Map<FXMLLoaderExt.SupportedType, Map<String, Method>> getControllerMethods() {
            if (controllerMethods == null) {
                controllerMethods = new EnumMap<>(FXMLLoaderExt.SupportedType.class);
                for (FXMLLoaderExt.SupportedType t: FXMLLoaderExt.SupportedType.values()) {
        ...
        private void addAccessibleMethods(final Class<?> type,
            ...
            for (int i = 0; i < methods.length; ++i) {
                ...
                final FXMLLoaderExt.SupportedType convertedType;
